...
The updated guide is available at [here](https://alwinegnerd.github.io/DragonFable-Private-Server/SETUP.html)
...
1. Clone this repository:
    ```sh
    git clone https://github.com/AlwinEgnerd/DragonFable-Private-Server
